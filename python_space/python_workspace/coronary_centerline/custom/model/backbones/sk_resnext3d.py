...
class SkResNeXt3D(nn.Module):
    def __init__(self, in_count=3, layers=[3, 4, 6, 3], baseWidth=4, cardinality=32, d_count=1000, c_count=1):
        """ Constructor
        Args:
        ...
        self.layer9 = conv_block(in_channels=1024, out_channels = 256, kernel_size=1, stride=1, p_size=0)
